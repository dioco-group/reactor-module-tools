...
// Load .env file from repo root (best-effort)
try {
 ...
 * @param {number} options.thinkingBudget - Gemini thinking budget (OpenAI-compatible extra_body.google.thinking_config.thinking_budget)
...
async function callGemini(prompt, options = {}) {
  ...
  // Vendor-specific extension supported by Gemini's OpenAI-compatible endpoint.
  // This can increase hidden "thinking tokens" for better reasoning.
...
function stripMarkdownCodeBlocks(text) {
  ...
  // Strip a leading fence with an optional language/info tag (```module, ```json, ```)
  // and a matching trailing fence.
